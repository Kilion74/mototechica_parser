...
count = 1
while count <= number:
    url = f'https://globaldrive.ru/novokuybyshevsk/catalog/mototekhnika/kvadrotsikly/?view=list&CF_CACHE_BITRIX_SM_ARG_CITY=1&_CF_CACHE_MOBILE=0&PAGEN_1={count}'
    headers = {
    ...
    for i in heads:
        ...
        with open('store.csv', 'a+', encoding='utf-16') as file:
